...
def annotate_interpro(interaction_dataframe, uniprot2interpro_dict, xref_columns=list(('xref_A', 'xref_B'))):
    interaction_dataframe['interpro_A'] = interaction_dataframe.apply(
        lambda x: uniprot2interpro_dict.get(x['xref_A'].split(':')[1], np.nan), axis=1)
    interaction_dataframe['interpro_B'] = interaction_dataframe.apply(
        lambda x: uniprot2interpro_dict.get(x['xref_B'].split(':')[1], np.nan), axis=1)
